...
def evaluate_all_models(directory, val_loader, log_dir):
...
# Example usage
directory = 'model/models/ust_chl_3'  # Update this to the path of your .pth files directory
...
mask_mode = 0  # Update this to the specific mask mode
...
evaluate_all_models(directory, val_loader, log_dir)
