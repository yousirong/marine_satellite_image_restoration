...
years = [year for year in years if year.isdigit()]  # 숫자가 아닌 항목 필터링
    ...
    for month in tqdm(months):
        ...
        if os.path.isdir(data_month):
            ...
            for img in imgs:
                ...
                if 'merged_daily_Chl' not in f.variables:
                    print(f"'merged_daily_Chl' not found in {img}.")
                    f.close()
                    continue
